import { CalendarCheck, Clock, Hash, Users } from "lucide-react";
      ...
      <div className="mx-auto max-w-5xl">
        <div className="glass-panel premium-ring rounded-[2rem] p-7 sm:p-10">
          ...
          <p className="mt-5 max-w-3xl leading-8 text-robot-muted">
            Thank you{reservation.firstName ? `, ${reservation.firstName}` : ""}. The Robot Cafe host team will confirm your table shortly.
          </p>
