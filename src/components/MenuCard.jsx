...
export default function MenuCard({ item, index }) {
  return (
    <motion.article
      ...
      className="premium-card-hover overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] transition hover:-translate-y-2 hover:border-robot-blue/50"
    >
