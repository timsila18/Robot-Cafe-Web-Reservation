...
export default function AboutPreviewSection() {
  return (
    <section id="about-preview" className="luxury-surface border-y border-white/10 bg-robot-navy/72 px-5 py-24 lg:px-6 light:border-slate-200 light:bg-slate-50">
